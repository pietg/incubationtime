...
The first moment is estimated by the mean of the nonparatric MLE (no smoothing is needed in this case). The estimates of the median and 95th percentile are based on the SMLE. The parametric estimates are computed using the R package nloptr.
